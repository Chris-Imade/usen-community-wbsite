(function (b) {
  ...
  function p(a) {
    a = b(a.target);
    "undefined" !== typeof b.fn.masonry &&
      a.outerFind(".mbr-gallery").each(function () {
        var c = b(this)
          .find(".mbr-gallery-row")
          .masonry({
  ...
  function q(a, c, b, d, f) {
    ...
    b = b >= l ? l : b;
    c = (c - (b * n) / l) / 2;
    g.css({ width: parseInt(b), height: (b * n) / l });
    a.css("top", c + d);
  }
  function x(a, c, e, d, f, g) {
    a.find(".modal-dialog .carousel-item").each(function () {
      if (
        (!g &&
          !b(this)[0].classList.contains("carousel-item-next") &&
          !b(this)[0].classList.contains("carousel-item-prev")) ||
        (g && !b(this)[0].classList.contains("active"))
      )
        b(this)[0].classList.contains("video-container")
          ? b(this).css({ top: d, height: e - 2 * d - 2 * f })
          : q(b(this), e, c, d, f);
    });
  }
  function r() {
    ...
    if (h) {
      ...
      h.find(
        ...
        : ((e = h.find(".modal-dialog .carousel-item.active")), (d = !0));
      e[0].classList.contains("video-container")
        ? e.css({ top: 0, height: c - 0 - 20 })
        : q(e, c, a, 0, 10);
      clearTimeout(t);
  ...
  if (!b("html").hasClass("is-builder")) {
    ...
    window.onYouTubeIframeAPIReady = function () {
      var a = a || {};
      a.YTAPIReady ||
        ((a.YTAPIReady = !0), jQuery(document).trigger("YTAPIReady"));
  ...
  b(document).on("add.cards", function (a) {
    ...
    c.on("click", ".mbr-gallery-filter li > .btn", function (a) {
      ...
      c.find(".mbr-gallery-item").each(function (a, c) {
        ...
        -1 !== b.inArray(g, f) || d.hasClass("mbr-gallery-filter-all")
          ? e.removeClass("mbr-gallery-item__hided")
          : (e.addClass("mbr-gallery-item__hided"),
            setTimeout(function () {
              e.css("left", "300px");
            }, 200));
      });
    ...
    function (a) {
      ...
      c.find(".mbr-gallery-item").each(function (a) {
        (b(this).attr("data-tags") || "")
          ...
          .map(function (a) {
            a = a.trim();
            -1 === b.inArray(a, d) && d.push(a);
          });
      });
      if (
        0 < c.find(".mbr-gallery-filter").length &&
        b(a.target)
          .find(".mbr-gallery-filter")
          .hasClass("gallery-filter-active") &&
        !b(a.target).find(".mbr-gallery-filter").hasClass("mbr-shop-filter")
      ) {
        var f = "",
